          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="mb-5 md:mb-6">
              ...
              >
                ...
                >
                  <div className="w-8 h-8 rounded-full bg-[var(--bg-card)] flex items-center justify-center mr-3 group-hover:bg-primary group-hover:text-[var(--text-primary)] transition-all shadow-md">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                  <div>
                    <h1 className="text-4xl md:text-5xl font-black tracking-tight flex items-center gap-4 mb-4 text-foreground">
                      <div className="w-14 h-14 bg-primary rounded-2xl flex items-center justify-center text-[var(--text-primary)] shadow-xl shadow-primary/20">
                              ...
                              <div className="bg-secondary/30 px-4 sm:px-8 py-4 sm:py-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-6 border-b border-border/50">
                                <div className="flex flex-wrap gap-x-10 gap-y-4 w-full sm:w-auto">
                                  <div className="space-y-1">
                                    <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[var(--text-secondary)]">Order Reference</p>
                                    <p className="font-mono text-sm font-bold bg-background px-3 py-1 rounded-lg border shadow-sm">
                                      #{order.id.slice(0, 8).toUpperCase()}
                                    </p>
                                  </div>
                                  <div className="space-y-1">
                                    <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[var(--text-secondary)]">Placed On</p>
                                  ...
                                  <div className="space-y-1">
                                    <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[var(--text-secondary)]">Status</p>
                                    <Badge 
                                  ...
                                  <div className="text-right ml-auto sm:hidden">
                                    <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[var(--text-secondary)] mb-1">Total Amount</p>
                                    <p className="text-2xl font-black text-primary tracking-tight price-display">₹{(order.total || 0).toLocaleString("en-IN")}</p>
                                  </div>
                                </div>
                              ...
                              <CardContent className="p-4 sm:p-8">
                                <div className="grid md:grid-cols-[1.5fr,1fr] gap-6 md:gap-12">
                                  ...
                                  <div className="flex flex-col gap-3">
                                    <h4 className="text-xs font-black text-[var(--text-secondary)] uppercase tracking-[0.25em] flex items-center gap-2">
                                    ...
                                    <div className="space-y-3 max-h-[360px] overflow-y-auto pr-1 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-track]:bg-secondary/30 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-primary/30">
                                      {itemsList.map((item: any, idx: number) => (
                                        <motion.div 
                                          ...
                                          whileHover={{ x: 5 }}
                                        >
                                          <div className="w-20 h-20 rounded-2xl bg-[var(--bg-card)] overflow-hidden shrink-0 border-2 border-border/50 shadow-sm group-hover/item:border-primary/30 transition-all">
                                            {item.image ? (
                                          ...
                                          <div className="flex-1 min-w-0">
                                            ...
                                            <div className="flex items-center justify-between">
                                              ...
                                              <div className="font-black text-lg price-display">₹{(item.price * item.quantity).toLocaleString("en-IN")}
                                              </div>
                                            </div>
                                          </div>
                                        </motion.div>
                                  ...
                                  <div className="space-y-8 md:border-l border-border/50 pl-0 md:pl-10">
                                    ...
                                    <div className="space-y-4">
                                      ...
                                      <div className="bg-secondary/30 p-6 rounded-[2rem] border border-border/30 relative overflow-hidden group/addr">
                                        ...
                                        <div className="space-y-1.5 text-[var(--text-primary)] text-sm font-semibold leading-relaxed">
                                    ...
                                    <div className="p-6 rounded-[2rem] bg-primary/5 border border-primary/10">
                                      ...
                                      <p className="text-xs text-[var(--text-secondary)] mb-4">Questions about delivery, quality, or returns?</p>
